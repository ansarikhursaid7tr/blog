...
admin.site.site_header = "Admin"  # "Django Administration"
admin.site.index_title = "Site administration "  # "Site administration".
admin.site.site_title = "Admin"  # "Django site admin"
